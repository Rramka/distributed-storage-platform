...
- Terminates TLS, authenticates requests (JWT access tokens, API keys), enforces per-account rate limits.
- Routes to internal services over gRPC; performs request validation and shapes errors into the common format defined in [08-api.md](08-api.md).
