...
**Status:** Phase 1 — solo builder track. Specs in `docs/` are canonical. **M0–M4 including challenges, scored scheduler, and the W10 fleet visualizer are in the repo.** Ledger and dashboards are deferred. See [[Map of Roadmap]].
