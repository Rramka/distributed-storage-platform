...
**Status:** Phase 1 — solo builder track. Specs in `docs/` are canonical. **M0–M2 are in the repo** (encrypted single-copy put/get through the node agent). Active scope is M0–M4 (durability demo); ledger and dashboards are deferred. See [[Map of Roadmap]].
