...
**Status:** Phase 1 — solo builder track. Specs in `docs/` are canonical. **M0 foundations and M1 metadata CRUD + API-key auth are in the repo.** Active scope is M0–M4 (durability demo); ledger and dashboards are deferred. See [[Map of Roadmap]].
